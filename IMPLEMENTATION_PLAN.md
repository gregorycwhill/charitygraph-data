...
Implement `CG-S0-PO-2026-09-22` through narrow Builder runtime predicates and
focused regression tests. This is not live S0 execution; Attempt 7 is read-only
historical evidence and a later execution must create a fresh attempt identity.
