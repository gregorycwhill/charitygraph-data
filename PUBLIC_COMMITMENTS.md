...
- **Model-assisted coverage:** use language and vision models where they materially improve recovery, interpretation or explanation, while keeping outputs source-linked, method-labelled, testable and correctable.
...
- **Coverage over paperwork:** treat governance as transparent evidence, policy and correction—not as a promise that every useful observation receives human review. We will not call a sparse result successful merely because it is easy to defend.
