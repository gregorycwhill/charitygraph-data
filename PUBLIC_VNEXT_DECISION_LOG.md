...
| CG-D025 | CharityGraph uses six distinct classification / regulatory lenses: ACNC Registration, ATO DGR, ACNC CLASSIE, UN SDG, CharityGraph Native and CharityGraph CLASSIE. They have different grains, authorities and assignment methods; no single master taxonomy is created. | Approved | Generic versioned schemes, mappings and assignments remain supported; ACNC dimensions stay separate; program-first lenses do not silently roll up. |
