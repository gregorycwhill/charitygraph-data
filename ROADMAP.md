...
**Milestone status (18 September 2026):** Phase 3 complete; Phase 4 complete; **Phase 5 complete: North Star v0.2 bounded completion gate passed**; the Scale S0 Factory is certified for a product-owner decision, while S0 and Top-100 scale remain unauthorised. Phase 6 is complete and not reopened. The bounded product-value commitment-content fix is complete. Capacity is assessed only as needed to represent active North Star section 7; this does not reopen Phase 6.
