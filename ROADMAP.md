...
Native induction sequencing and the parked V1–V3 findings are governed by [CHARITYGRAPH_NATIVE_ARCHITECTURE.md](CHARITYGRAPH_NATIVE_ARCHITECTURE.md). The next Native experiment remains deliberately unspecified pending that decision.
