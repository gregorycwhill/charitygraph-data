...
| Active Phase 5 North Star vNext projection vocabulary and epistemic rules | `NORTH_STAR_TARGET_CARD.md` (internal planning projection contract; not a public schema) |
