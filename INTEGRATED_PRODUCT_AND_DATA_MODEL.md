...
Native overlay, promotion and lifecycle boundaries are captured in [CHARITYGRAPH_NATIVE_ARCHITECTURE.md](CHARITYGRAPH_NATIVE_ARCHITECTURE.md); canonical semantic objects remain independent of optional Native classification.
