...
**Status:** Phase 3 complete. Phase 4 complete. **Phase 5 complete: North Star v0.2 bounded completion gate passed. The Scale S0 Factory is mechanically certified for a product-owner decision; S0 and Top-100 scale remain unauthorised.** Phase 6 is complete and not reopened. The product-value bounded commitment-content fix is complete. Capacity is a Phase 5 completion question only to the extent active section 7 needs an honest representation; this does not reopen Phase 6. No production-complete claim is made.

**S0 decision pending (18 September 2026):** The Factory certification and retained-evidence policy calibration are complete, including a deliberately non-executable shadow mandate and provider-free shadow run. They are proposals for a product-owner decision, not S0 authorisation. See `SCALE_S0_POLICY_CALIBRATION_2026-09-18.md`, `SCALE_S0_SHADOW_RUN_2026-09-18.md` and `SCALE_S0_PRODUCT_OWNER_DECISION_V2.md`.
